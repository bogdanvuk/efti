...
#define NUM_INST_MAX			1024

#define CEILING(x,y) (((x) + (y) - 1) / (y))

#define INST_MEM_BANKS_NUM			CEILING(NUM_ATTRIBUTES * ATTRIBUTE_RES, 32)
#define INST_MEM_ADDR_WIDTH 		10			// ceil(log2(NUM_INST_MAX))
...
#define DT_MEM_ADDR_WIDTH			3			// ceil(log2(NUM_NODES))
